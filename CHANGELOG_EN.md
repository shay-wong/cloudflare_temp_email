...
- feat: |Admin| Allow admin create-address to leave the mailbox name blank for backend random generation, and add a "Use Random Name" action in the admin panel
...
- fix: |Admin| Make the admin create-address “Use Random Name” action immediately fill the address input with a random mailbox name instead of only clearing the field
